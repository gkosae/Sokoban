...
//							newPos.x, newPos.y));
	 ...
	 */
	public boolean pointHas(Point pos, byte field) {
	 ...
	 */
	public BoardState parseBoardInput(String boardInput) throws IOException {
		...
		reader.close();
		BoardState newState = new BoardState(boardPoints, player, goals, boxes);
